...
interface EditRooferProps {
  roofer: RooferData;
  onBack: () => void;
}

export function EditRoofer({ roofer, onBack }: EditRooferProps) {
  ...
  const handleDelete = () => {
    // Handle roofer deletion
    if (confirm('Are you sure you want to delete this roofer? This action cannot be undone.')) {
      console.log('Deleting roofer:', roofer.id);
      onBack();
    }
  };
