...
export const Toast = ({ type, message, onClose, duration = 5000 }) => {
    ...
    return (_jsx("div", { className: `fixed top-4 right-4 z-50 max-w-sm w-full bg-white border rounded-lg shadow-lg p-4 ${typeStyles[type]}`, children: _jsxs("div", { className: "flex items-start", children: [_jsx("div", { className: `flex-shrink-0 ${iconStyles[type]}`, children: getIcon() }), _jsx("div", { className: "ml-3 flex-1", children: _jsx("p", { className: "text-sm font-medium", children: message }) }), _jsx("div", { className: "ml-4 flex-shrink-0", children: _jsx("button", { onClick: onClose, className: `inline-flex text-gray-400 hover:text-gray-600 focus:outline-none focus:text-gray-600`, children: _jsx("svg", { className: "h-5 w-5", fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { fillRule: "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", clipRule: "evenodd" }) }) }) })] }) }));
};
