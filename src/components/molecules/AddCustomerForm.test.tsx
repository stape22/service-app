...
describe('AddCustomerForm', () => {
  ...
  it('renders all required fields', () => {
    render(<AddCustomerForm onBack={() => {}} availableRoofers={availableRoofers} />);
  ...
  it('calls onSubmit with form data and onBack when valid', () => {
    ...
    render(<AddCustomerForm onBack={onBack} onSubmit={onSubmit} availableRoofers={availableRoofers} />);
