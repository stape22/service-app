...
export const EditCustomerForm = ({ customer, onBack, onSubmit, onDelete, availableRoofers = [] }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        assignedRoofer: customer.assignedRoofer || '',
    });
