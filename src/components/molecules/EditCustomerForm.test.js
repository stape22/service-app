...
describe('EditCustomerForm', () => {
    ...
    it('renders all required fields with initial values', () => {
        render(_jsx(EditCustomerForm, { customer: customer, onBack: () => { }, availableRoofers: availableRoofers }));
    ...
    it('calls onSubmit with updated data and onBack when valid', () => {
        ...
        render(_jsx(EditCustomerForm, { customer: customer, onBack: onBack, onSubmit: onSubmit, availableRoofers: availableRoofers }));
    ...
    it('calls onDelete and onBack when Delete Customer is confirmed', () => {
        ...
        render(_jsx(EditCustomerForm, { customer: customer, onBack: onBack, onDelete: onDelete, availableRoofers: availableRoofers }));
