...
export const EditCustomerForm: React.FC<EditCustomerFormProps> = ({ customer, onBack, onSubmit, onDelete, availableRoofers = [] }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (onSubmit) onSubmit({ ...formData, contacts, id: customer.id });
    onBack();
  };
