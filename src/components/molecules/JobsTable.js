...
export const JobsTable = ({ onEditJob }) => {
    ...
    return (_jsx("div", { className: "overflow-x-auto", children: _jsxs(Table, { children: [_jsx(TableHeader, { children: _jsxs(TableRow, { children: [_jsx(TableHead, { className: "cursor-pointer", onClick: () => handleSort('id'), children: _jsxs("div", { className: "flex items-center", children: ["Job #", _jsx(SortIcon, { field: "id" })] }) }), _jsx(TableHead, { className: "cursor-pointer", onClick: () => handleSort('date'), children: _jsxs("div", { className: "flex items-center", children: ["Date", _jsx(SortIcon, { field: "date" })] }) }), _jsx(TableHead, { className: "cursor-pointer", onClick: () => handleSort('jobType'), children: _jsxs("div", { className: "flex items-center", children: ["Job Type", _jsx(SortIcon, { field: "jobType" })] }) }), _jsx(TableHead, { className: "cursor-pointer", onClick: () => handleSort('status'), children: _jsxs("div", { className: "flex items-center", children: ["Status", _jsx(SortIcon, { field: "status" })] }) }), _jsx(TableHead, { className: "cursor-pointer", onClick: () => handleSort('roofer'), children: _jsxs("div", { className: "flex items-center", children: ["Roofer", _jsx(SortIcon, { field: "roofer" })] }) }), _jsx(TableHead, { className: "cursor-pointer", onClick: () => handleSort('address'), children: _jsxs("div", { className: "flex items-center", children: ["Address", _jsx(SortIcon, { field: "address" })] }) }), _jsx(TableHead, { className: "cursor-pointer", onClick: () => handleSort('customer'), children: _jsxs("div", { className: "flex items-center", children: ["Customer", _jsx(SortIcon, { field: "customer" })] }) })] }) }), _jsx(TableBody, { children: sortedJobs.map((job) => (_jsxs(TableRow, { className: "hover:bg-blue-50 cursor-pointer", onClick: () => onEditJob?.(job.id), children: [_jsx(TableCell, { className: "text-right font-mono", children: job.id }), _jsx(TableCell, { children: job.date }), _jsx(TableCell, { children: job.jobType }), _jsx(TableCell, { children: _jsx(Badge, { variant: "secondary", className: `text-xs px-2 py-1 border ${statusColors[job.status]}`, children: job.status.replace('-', ' ') }) }), _jsx(TableCell, { children: job.roofer }), _jsx(TableCell, { children: job.address }), _jsx(TableCell, { children: job.customer })] }, job.id))) })] }) }));
};
