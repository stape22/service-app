...
describe('TopNav', () => {
    it('renders logo/brand and navigation links', () => {
        render(_jsx(MemoryRouter, { children: _jsx(TopNav, { userName: "Alice" }) }));
    ...
    it('renders user avatar with initial', () => {
        render(_jsx(MemoryRouter, { children: _jsx(TopNav, { userName: "Bob" }) }));
        expect(screen.getByText('B')).toBeInTheDocument();
    });
    it('renders avatar fallback if no userName', () => {
        render(_jsx(MemoryRouter, { children: _jsx(TopNav, {}) }));
